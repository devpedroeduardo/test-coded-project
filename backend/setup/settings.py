...
SECRET_KEY = 'django-insecure-07vr*f9*$rkp_c)v_oq^&al%0*9y%09f9hepw0+q!731&*mu*$'
...
# Diz ao Django para usar o nosso modelo de usuário com PROFESSOR e ALUNO
AUTH_USER_MODEL = 'escola.User'

# Exige que toda a API use o Token JWT para autenticação
REST_FRAMEWORK = {
